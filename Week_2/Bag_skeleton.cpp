...
Bag::Bag(size_t initialCapacity) {
    ...
    // Print a message about memory allocation
}

// Destructor
Bag::~Bag() {
    // TODO: Deallocate memory for data array
    // Print a message about memory deallocation
}
...
Bag::Bag(const Bag& other) {
    ...
    // Print a message about creating a deep copy
}
...
Bag& Bag::operator=(const Bag& other) {
    ...
    // Allocate new memory
    // Copy elements
    // Print a message about copy assignment
    return *this;
}
...
void Bag::resize(size_t newCapacity) {
    ...
    // Delete old array
    // Update capacity
    // Print a message about resizing
}